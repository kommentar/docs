---
title: Patterns
description: Patterns used by Kommentar
---

## Ports and Adapters Pattern

Kommentar's core application is built using the Ports and Adapters pattern, also known as the Hexagonal Architecture. This pattern allows for a clean separation between the core application logic and the external systems it interacts with, such as databases, web servers, and APIs. The architecture is designed to be modular and flexible, making it easy to adapt to different technologies and frameworks.
